...
#define GRID_SIZE       64
#define NUM_PARTICLES   16384 //16384

const uint width = 640, height = 480; // 640, 480
...
GLuint SkyShaderProgram = 0, SkyVertShader = 0, SkyFragShader = 0; 
GLuint createShader(char* src, GLenum type);
GLuint cubeMapId;

//function declare for skybox
char* ReadFile(char *filename);
void CubeMapTexture();
void SkyBoxDataTransfer();

//Enviro Global variable
GLuint skyVAO;
GLuint skyVBO;
...
// skybox
void createProgram(){
	char *vertexShaderSource = ReadFile("Skybox.vs");
	char *fragmentShaderSource = ReadFile("Skybox.fs");
...
void CubeMapTexture(){
	...
	Bitmap bmp = Bitmap::bitmapFromFile("textures/cubemap6.jpg");
	...
	bmp = Bitmap::bitmapFromFile("textures/cubemap1.jpg");
